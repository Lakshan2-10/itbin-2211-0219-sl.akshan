...
public class ManageCategory extends javax.swing.JFrame {
    ...
    public void ValidateFields() {
        String category = nameTb.getText();
        if (!category.equals("")) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(298, 30, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(471, 173, 362, 213));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("VIEW CATEGORY");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(583, 138, -1, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("ADD NEW CATEGORY");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(164, 181, -1, -1));
        ...
        jPanel1.add(nameTb, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 233, 284, -1));
        ...
        saveBtn.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent evt) {
                saveBtnComponentShown(evt);
            }
        });
        ...
        jPanel1.add(saveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 289, -1, -1));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(283, 289, -1, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 30, -1, -1));
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        category.setName(nameTb.getText());
        CategoryDao.save(category);
        setVisible(false);
        new ManageCategory().setVisible(true);
    }//GEN-LAST:event_saveBtnActionPerformed

    private void saveBtnComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_saveBtnComponentShown
        

    }//GEN-LAST:event_saveBtnComponentShown
    ...
    private void catTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_catTableMouseClicked
        ...
        int a = JOptionPane.showConfirmDialog(null, "Do you want to delete " + name + " Category");
        if (a == 0) {
